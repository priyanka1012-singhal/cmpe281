                    ...
                    <tbody>
						<c:forEach var="cluster" items="${clusterList}" >
							<tr class="back">
								...
								<td>
								<button class="edit"  onclick="window.open('/CloudSense/editcluster/${cluster.id}', '_self')">Edit</button>
								<button class= "delete" onclick="window.open('/CloudSense/deletecluster/${cluster.id}', '_self')">Delete</button>
								</td>
