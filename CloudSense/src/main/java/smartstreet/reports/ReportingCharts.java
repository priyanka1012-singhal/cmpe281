 ...
 */
package smartstreet.reports;

public class ReportingCharts {
    ...
    public ReportingCharts(String type, String id, String width, String height, String renderAt, String dataFormat, String dataSource) {
